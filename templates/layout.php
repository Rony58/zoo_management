    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-lg-8 col-md-6 mb-4">
          ...
          <p class="text-muted text-small">Bangladesh National Zoo, (Bengali: বাংলাদেশ জাতীয় চিড়িয়াখানা) is a zoo located in the Mirpur section of Dhaka, the capital city of Bangladesh. The zoo contains many native and non-native animals and wild life, and hosts about three million visitors each year. On 5 February 2015, the name changed from Dhaka Zoo to Bangladesh National Zoo.</p>
          <p class="text-muted text-small">Established in 1974, the 186-acre (75 ha) Bangladesh National Zoo is the largest zoo in Bangladesh, and is operated by the Ministry of Fisheries and Livestock.[3] The zoo attracts around 10,000 visitors every day with the number increasing during the weekends[4] and holidays. The zoo is also known for its poor conditions for animals and the corruption of its officials.</p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
          <h5 class="lined lined-dark mb-3 color-header">Our Location</h5>
          <h6>Zoo Management System</h6>
          <p class="text-muted mb-0 text-small">Bangladesh National Zoo</p>
          <p class="text-muted mb-0 text-small">1216 Dhaka, Mirpur</p>
          <p class="text-muted mb-4 text-small">Mobile +880 1865 - 582517 </p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
