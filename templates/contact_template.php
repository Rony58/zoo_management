<section class="py-5 bg-cover bg-gray">
    <div class="container py-5">
        ...
        <p class="lead my-4">If you need any question queries please contact us.</p>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-lg-12 col-md-6 mb-4">
                        ...
                        <p class="text-muted mb-0 text-small">Dhaka<strong>St </strong></p>
                    </div>
                    <div class="col-lg-12 col-md-6 mb-4">
                        <div class="icon mb-4"><i class="pe-7s-phone"></i></div>
                        <h5 class="lined mb-4">Call center</h5>
                        <p class="text-muted mb-3 text-small">Write an your feedback</p>
                        <p class="text-muted font-weight-bold">+880 1865-582517</p>
                    </div>
                    <div class="col-lg-12 col-md-6 mb-4">
            ...
            <div class="col-lg-7 ml-auto">
                <div class="col-lg-12 col-md-6 mb-4">
                    ...
                    <p class="text-muted text-small">If you need any question queries please contact us.</p>
